...
var SupportedModels = []ModelInfo{
	// OpenAI
	{ID: "gpt-5.4", Name: "GPT 5.4", Provider: "OpenAI", Description: "旗舰通用模型，综合能力强", Color: "#10a37f", Capabilities: []string{"chat", "search"}},
	{ID: "gpt-5.4-mini", Name: "GPT 5.4 Mini", Provider: "OpenAI", Description: "快速、经济，日常任务首选", Color: "#10a37f", Capabilities: []string{"chat", "search"}},
	{ID: "gpt-5.5", Name: "GPT 5.5", Provider: "OpenAI", Description: "第五代增强版，更强推理能力", Color: "#10a37f", Capabilities: []string{"chat", "search"}},
	{ID: "gpt-5.5-pro", Name: "GPT 5.5 Pro", Provider: "OpenAI", Description: "旗舰级专业模型，最强的多模态能力", Color: "#10a37f", Capabilities: []string{"chat", "search"}},
