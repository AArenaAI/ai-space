...
type MessageFavorite struct {
	...
	UserID    uint      `gorm:"not null;uniqueIndex:idx_user_fav_unique" json:"user_id"`
	MessageID uint      `gorm:"not null;uniqueIndex:idx_user_fav_unique" json:"message_id"` // AI 消息 ID
