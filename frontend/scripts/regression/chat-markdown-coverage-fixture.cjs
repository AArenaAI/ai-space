...
const expectations = {
  ...
  tableBlock: { label: '表格块容器', selector: '[data-testid="markdown-table-block"]', min: 1 },
  tableStrong: { label: '表格内粗体', selector: 'table strong', min: 1 },
  tableStickyHeader: { label: '表格 sticky header', selector: '[data-testid="markdown-table-block"] thead.sticky', min: 1 },
