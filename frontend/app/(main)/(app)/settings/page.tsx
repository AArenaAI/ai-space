...
type Tab = "general" | "templates" | "betaCode" | "feedback";
    ...
    <div className="mx-auto max-w-3xl px-8 py-8">
      <div className="rounded-[34px] bg-white p-7 shadow-[0_24px_80px_rgba(15,23,42,0.10)] md:p-8">
        ...
        <div className="mt-6 rounded-2xl border border-[#e5e7eb] p-4 text-center">
          ...
          <button onClick={() => router.push("/beta/apply")} className="mt-3 text-sm font-semibold text-[#111827] underline-offset-4 hover:underline">
            提交内测申请
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex h-full bg-surface-elevated">
      ...
      >
        ...
        {activeTab === "betaCode" && <BetaCodeSection />}
