  ...
  return (
    ...
    >
      <div className="pointer-events-auto relative flex max-h-full items-center justify-end">
        ...
        <div
          className="absolute inset-y-0 right-0 w-8 opacity-0 transition-opacity duration-200 group-hover:opacity-0"
        ...
        >
          {items.map((item) => (
            <button
              ...
              className={cn(
                "group/item flex h-[10px] w-full items-center justify-end rounded-lg text-left outline-none transition-opacity duration-200 focus-visible:ring-2 focus-visible:ring-brand/35 group-hover:min-h-7 group-hover:justify-between group-hover:gap-2 group-hover:px-2",
            ...
            >
              <span className="hidden min-w-0 flex-1 truncate text-xs leading-7 opacity-0 transition-opacity duration-150 group-hover:block group-hover:opacity-100">
                {item.label}
              </span>
              <span
                className={cn(
