...
function MessageRow({
  ...
  return (
    <div data-chat-message-row="true" data-message-id={msg.id} className={cn("max-w-[800px] mx-auto px-4 py-4 rounded-2xl transition-colors duration-500", isHighlighted && "bg-brand/10")}>
