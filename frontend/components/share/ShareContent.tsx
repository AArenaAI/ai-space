...
<span className="text-[11px] text-gray-400 font-mono uppercase">{language || "text"}</span>
</div>
<SyntaxHighlighter
          ...
          {results.map((res) => {
            ...
            return (
              <div key={res.model_id} className="rounded-xl border border-surface-border bg-surface-elevated flex flex-col overflow-hidden">
                ...
                <div className="flex-1 px-4 py-3 max-h-[60vh] overflow-y-auto prose prose-sm prose-invert max-w-none text-[14px] leading-relaxed text-text-primary">
                  {res.error ? (
